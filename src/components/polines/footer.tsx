...
import { Heart, AlertTriangle, Star, Users, HandHeart, Mail, Phone, Globe, MapPin,} from "lucide-react";
import Image from "next/image";

export function Footer() {
  return (
    <footer className="bg-linear-to-r from-teal-800 to-emerald-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-teal-200 text-sm leading-relaxed">
              Platform donasi kampus Politeknik Negeri Semarang untuk menggalang
              kepedulian dan dana bantuan sosial, bencana, serta kegiatan
              keagamaan.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-teal-200 text-sm">
              <li className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
                <AlertTriangle className="h-3 w-3" /> Bencana Alam
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
                <Star className="h-3 w-3" /> Kegiatan Ramadhan
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
                <Users className="h-3 w-3" /> Kegiatan Sosial
              </li>
              <li className="flex items-center gap-2 cursor-pointer hover:text-white transition-colors">
                <HandHeart className="h-3 w-3" /> Donasi Rutin
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="text-center text-teal-300 text-sm">
          &copy; {new Date().getFullYear()} Polines Care &mdash; Politeknik
          Negeri Semarang. Hak Cipta Dilindungi.
        </div>
      </div>
    </footer>
  );

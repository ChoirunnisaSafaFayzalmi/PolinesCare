...
export function DonaturDashboard({
  ...
  <TabsTrigger value="donasi" className="text-sm data-[state=active]:bg-teal-600 data-[state=active]:text-white">
    <HandHeart className="h-4 w-4 mr-1.5" /> Donasi
  </TabsTrigger>
  <TabsTrigger value="riwayat" className="text-sm data-[state=active]:bg-teal-600 data-[state=active]:text-white">
    <ClipboardList className="h-4 w-4 mr-1.5" /> Riwayat
  </TabsTrigger>
  <TabsTrigger value="rekomendasi" className="text-sm data-[state=active]:bg-teal-600 data-[state=active]:text-white">
    <Star className="h-4 w-4 mr-1.5" /> Rekomendasi
  </TabsTrigger>
  <TabsTrigger value="ajuan" className="text-sm data-[state=active]:bg-teal-600 data-[state=active]:text-white">
  <Megaphone className="h-4 w-4 mr-1.5" /> Ajuan
</TabsTrigger>
  <TabsTrigger value="profil" className="text-sm data-[state=active]:bg-teal-600 data-[state=active]:text-white">
  ...
  <div className="space-y-4">
    ...
    <div className="p-4 bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg border border-teal-200">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-semibold text-teal-800">Ajukan Campaign Donasi</p>
          <p className="text-xs text-teal-700 mt-0.5 leading-relaxed">
            Punya ide campaign donasi? Ajukan ke admin dan bantu lebih banyak orang.
            Setiap ajuan akan dinilai kelayakannya sebelum disetujui.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      {[
        { step: '1', title: 'Isi Formulir', desc: 'Lengkapi data pengaju dan informasi campaign' },
        { step: '2', title: 'Penilaian Otomatis', desc: 'Sistem menilai kelayakan campaign secara otomatis' },
        { step: '3', title: 'Review Admin', desc: 'Admin meninjau dan memutuskan persetujuan' },
      ].map(({ step, title, desc }) => (
        <div key={step} className="bg-white border rounded-lg p-4 flex items-start gap-3">
